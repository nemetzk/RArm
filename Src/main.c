...
void motion_init (struct motionth *motionb)
{
/* **********		SBUS  ********** */
...
/* **********		SERVO D - JOG MODE ********** */
	...
	motionb->servoD.limitSwitch.Conf.GPIO_Pin_CW = VA_ELOL_Pin;
	motionb->servoD.limitSwitch.Conf.GPIO_Pin_CCW = VA_HATUL_Pin;
...
/* **********		RC TRANSMITTER CHANNEL CONFIG 1 ********** */
	...
	motionb->sbus.sbusCh[SG].digVal.calculationEnabled=1;
	motionb->sbus.sbusCh[SG].digVal.Aval = 300;
	motionb->sbus.sbusCh[SG].digVal.Bval = 1000;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED_STAT_0_Pin|LED_STAT_1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : VA_HATUL_Pin VA_ELOL_Pin */
  GPIO_InitStruct.Pin = VA_HATUL_Pin|VA_ELOL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_STAT_0_Pin LED_STAT_1_Pin */
  GPIO_InitStruct.Pin = LED_STAT_0_Pin|LED_STAT_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
